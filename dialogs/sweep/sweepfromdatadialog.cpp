...
{
    // TODO: RUN PYTHON PLOTTING FUNCTIONS ON-DEMAND.
    //       SHOW REQUIRED PLOTS (DIRECTLY FROM DATA)
...
//    mpVariablesResultTab = new SweepResultVariableTab(mVarNameToPlotMap);
    ...
    connect(mpButtonBox, &QDialogButtonBox::accepted, this, &SweepFromDataDialog::accept);
