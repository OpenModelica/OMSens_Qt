...
ParametersExtendedTab::ParametersExtendedTab(QList<QString> parameters, QWidget *parent) : QWidget(parent)
{
    ...
    mpBriefDescriptionLabel = new QLabel("The total #iterations will be the product of the #iterations of all the parameters.", this);
    //Initialize table header
    mpParametersTable = new QTableWidget(0, 4, this);
    ...
    foreach (QString param_name, parameters)
    {
        ...
        // #iters spinbox
        QSpinBox *pIterationsSpinBox = new QSpinBox(this);
        ...
        // Percentage spinbox
        QDoubleSpinBox *pPercentageBox = new QDoubleSpinBox(this);
